...
export const sampleBusinesses: Business[] = [
  {
    ...
    businessName: "Sri Saravana Bhavan",
    ownerName: "Natarajan S",
    categoryId: 3,
    categoryName: "Food & Beverages",
    description: "Authentic South Indian vegetarian restaurant known for variety and quality.",
    address: "Five Roads Junction",
    area: "Five Roads",
    city: "Salem",
    state: "Tamil Nadu",
    pincode: "636004",
  ...
  },
  {
    ...
    businessName: "AVR Swarna Mahal",
    ownerName: "Siddhanth A",
    categoryId: 27,
    categoryName: "Jewellery",
    description: "Exquisite gold, diamond and silver jewellery collection.",
    address: "Swarnapuri",
    area: "Swarnapuri",
    city: "Salem",
    state: "Tamil Nadu",
  ...
  },
  {
    ...
    businessName: "Knowledge Institute of Technology",
    ownerName: "Dr. Srinivasan",
    categoryId: 2,
    categoryName: "Education & Academies",
    description: "Premier engineering institute with focus on research and placement.",
    address: "Kakapalayam",
    area: "Kakapalayam",
    city: "Salem",
    state: "Tamil Nadu",
...
export const partnerCities = [
  "Salem", "Attur", "Mettur", "Edappadi", "Omalur", "Sankari"
];
