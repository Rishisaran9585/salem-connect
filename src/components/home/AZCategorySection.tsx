      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-16">
          ...
          <div className="w-full lg:w-1/3 flex flex-col">
            <div className="mb-8">
              <h2 className="text-2xl font-display font-semibold md:text-3xl text-foreground tracking-tight">
                Comprehensive Directory
              </h2>
              <p className="mt-4 text-base font-body text-muted-foreground/80">
            ...
            <motion.div
              ...
              className="relative flex-grow rounded-[2rem] overflow-hidden shadow-elevated min-h-[250px]"
            >
              <img
                src="/a-z-bg.png"
            ...
            <div className="mb-8 flex flex-wrap gap-1.5">
              {alphabet.map((letter) => (
                <button
                  ...
                  className={`h-9 w-9 md:h-10 md:w-10 rounded-lg text-sm font-sans font-semibold transition-all duration-300 ${activeLetter === letter
