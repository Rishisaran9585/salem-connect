   ...
   return (
      <div className="min-h-screen bg-gray-50 flex flex-col">
         ...
         <main className="flex-grow">
            ...
            <div className="bg-slate-900 pt-32 pb-24 md:pt-40 md:pb-32 relative overflow-hidden">
                        ...
                        <div className="space-y-12">
                           ...
                           <div className="flex gap-6 group/item">
                              ...
                              <div>
                                 ...
                                 <p className="text-xl font-display font-bold text-indigo-600">Meyyanur Road, Salem.</p>
